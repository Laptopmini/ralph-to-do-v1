...
### 1. Tech Stack {{PLAN_CONTEXT}} Architecture Notes
...
### 2. File {{PLAN_CONTEXT}} Code Structure
...
## Ticket 1: Todo Logic {{TICKET_TITLE}} Data Layer
...
```
# PRD: Todo Logic {{TICKET_TITLE}} Data Layer
...
Now call the Write tool to create `PRD.md` for Ticket 1: Todo Logic {{TICKET_TITLE}} Data Layer. Do not print the file contents in your response.
